...
try:
    ...
    #engine12 = sql.create_engine("""mssql+pyodbc://sa:DWpln21@WIN-SERVIDOR-BD\DWGRUPOTOTAL:1433/
    ...
    #engine21 = sql.create_engine("mssql+pyodbc://DRIVER={ODBC Driver 17 for SQL Server};SERVER=WIN-SERVIDOR-BD/DWGRUPOTOTAL:1433;DATABASE=DW_central;UID=Prueba;PWD=Prueba_1");
